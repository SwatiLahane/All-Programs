...
//accept n numbers from user and return Odd Addition of Numbers 
...
{    
    ...
    for(icnt = 0; icnt < iSize; icnt++)   //O(N)
    {
     ...
     iRet = OddAddition(ptr, iSize);//function call
     
     cout<<"Addition of all Odd elements of Array is :"<<iRet<<"\n";
    delete []ptr;//100
